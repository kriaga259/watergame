...
- figuring out how use the different files in Godot and rearranging layers
- adding an image of a cat
- creating a game!

Playable link: https://chamelemon.itch.io/water
(I haven't figured out how to update the game on itch.io yet, so this is an older version of the game. Below is an image showing more of the updated map.

<p align="left">
    <img width="1150" height="640" alt="image" src="https://github.com/user-attachments/assets/03dcda56-677f-4e9b-ba2e-a0a0da218f89" />
    </p>
